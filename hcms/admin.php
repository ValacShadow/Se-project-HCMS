...
<form  action="signup.php" method="post">
    <div class="dv">
	  ...
	  <select id="role" name="role" style="width:150px;height:30px;">
...
<form  action="delete.php" method="post">
    <div class="dv" >
      <label for="Title"><b>username</b></label><br>
  ...
  <br><br>
<a href="index.php" <button style="width:auto;align:center;" >Back to homepage</button></a>
   </aside>
</section>
<br><br><br><br><br><br>
